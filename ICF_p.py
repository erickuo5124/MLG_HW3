# Item-based Collaborative Filtering with pearson correlation similarity
import numpy as np
import pandas as pd
from utils.evaluation import print_evalution
from utils.CF import get_ratings, get_value_index_pearson
...
if __name__ == '__main__':
  ...
  max_value, max_index = get_value_index_pearson(predict[:,:train_length], datas[:,:train_length])
